...
_SUBMISSIONPAYLOAD = _descriptor.Descriptor(
  name='SubmissionPayload',
  full_name='SubmissionPayload',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='keys', full_name='SubmissionPayload.keys', index=0,
...
_SUBMISSIONPAYLOAD.fields_by_name['keys'].message_type = _TEMPORARYEXPOSUREKEY
...
DESCRIPTOR.message_types_by_name['SubmissionPayload'] = _SUBMISSIONPAYLOAD
...
SubmissionPayload = _reflection.GeneratedProtocolMessageType('SubmissionPayload', (_message.Message,), dict(
  DESCRIPTOR = _SUBMISSIONPAYLOAD,
  __module__ = 'format_pb2'
  # @@protoc_insertion_point(class_scope:SubmissionPayload)
  ))
_sym_db.RegisterMessage(SubmissionPayload)
...
TEKSignatureList = _reflection.GeneratedProtocolMessageType('TEKSignatureList', (_message.Message,), dict(
...
TEKSignature = _reflection.GeneratedProtocolMessageType('TEKSignature', (_message.Message,), dict(
